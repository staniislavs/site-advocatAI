      ...
      <div className="max-w-4xl mx-auto px-6 py-24 md:py-40">
        ...
        <motion.div style={{ y: typeof window !== 'undefined' && window.innerWidth < 768 ? 0 : textY }} className="w-full space-y-12">
          ...
          <div className="pt-4 text-center">
            <a href="#kontakty" className="bg-sage hover:bg-sage-light text-navy font-bold px-10 py-4 rounded-full inline-block transition-all shadow-xl shadow-sage/10 active:scale-95">
              {t('about.cta')}
            </a>
          </div>
        </motion.div>
