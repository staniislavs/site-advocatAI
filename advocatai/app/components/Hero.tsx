        ...
        <motion.div style={{ y, opacity }} className="flex flex-col justify-center text-center lg:text-left items-center lg:items-start">
          ...
          >
            <Link
              ...
              className="bg-sage hover:bg-sage-light text-navy-deep font-bold px-8 py-4 md:px-10 md:py-5 rounded-full transition-all group flex items-center justify-center gap-3 shadow-xl shadow-sage/20 active:scale-95 text-sm md:text-base w-full sm:w-auto"
            >
              {t('hero.cta_free')}
