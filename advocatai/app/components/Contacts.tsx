        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 grid md:grid-cols-5 gap-16 md:items-center">
            ...
            >
                ...
                <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
                  ...
                  <button 
                    disabled={loading}
                    className="w-full bg-sage hover:bg-sage-light disabled:opacity-50 disabled:cursor-wait text-navy font-bold py-5 rounded-xl transition-all shadow-xl shadow-sage/10 mt-4 active:scale-[0.98] flex items-center justify-center gap-2"
                  >
