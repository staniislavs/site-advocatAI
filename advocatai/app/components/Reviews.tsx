      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          ...
          <div className="flex items-center gap-4">
            <button 
              onClick={prev}
              className="w-14 h-14 rounded-full border border-sage/20 flex items-center justify-center text-sage hover:bg-sage hover:text-navy-deep transition-all group"
            >
        ...
        >
          <button 
            ...
            className="group relative px-10 py-4 bg-sage hover:bg-sage-light text-[var(--navy-deep)] rounded-full transition-all duration-500 shadow-xl shadow-sage/10 active:scale-95 flex items-center gap-3"
          >
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <button 
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full h-16 bg-[#c5a059] text-white font-bold uppercase tracking-[0.3em] text-[10px] rounded-full hover:bg-[#b08d4a] transition-all flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed mt-8 shadow-xl shadow-sage/20"
                    >
                      {isSubmitting ? (
