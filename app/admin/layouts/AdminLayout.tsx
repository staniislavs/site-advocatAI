...
const sidebarItems = [
  ...
  { id: 'email', label: 'Сповіщення', icon: Mail, path: '/admin/email' },
  { id: 'seo', label: 'SEO', icon: Search, path: '/admin/seo' },
  { id: 'admins', label: 'Адміни', icon: Shield, path: '/admin/admins' },
  { id: 'backup', label: 'Резервна копія', icon: Download, path: '/admin/backup' },
